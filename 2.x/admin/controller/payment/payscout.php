...
class ControllerPaymentPayscout extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['payscout_client_id'])) {
			$data['payscout_client_id'] = $this->request->post['payscout_client_id'];
		} else {
			$data['payscout_client_id'] = $this->config->get('payscout_client_id');
		}
		...
		if (isset($this->request->post['payscout_hash'])) {
			$data['payscout_hash'] = $this->request->post['payscout_hash'];
		} else {
			$data['payscout_hash'] = $this->config->get('payscout_hash');
		}
		...
		if (isset($this->request->post['payscout_mode'])) {
			$data['payscout_mode'] = $this->request->post['payscout_mode'];
		} else {
			$data['payscout_mode'] = $this->config->get('payscout_mode');
		}

		if (isset($this->request->post['payscout_method'])) {
			$data['payscout_method'] = $this->request->post['payscout_method'];
		} else {
			$data['payscout_method'] = $this->config->get('payscout_method');
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['payscout_client_id']) {
