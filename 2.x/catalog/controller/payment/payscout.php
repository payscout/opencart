...
class ControllerPaymentPayscout extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payscout.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/payscout.tpl', $data);
		} else {
			return $this->load->view('default/template/payment/payscout.tpl', $data);
		}
	}
	...
	public function send() {
		...
		$request = array(
			'client_id' => $this->config->get('payscout_client_id'),
		...
		if (curl_error($curl)) {
			...
			if (isset($response_object['status']) &&  $response_object['status'] == 'approved') {
				...
				$message .= 'Message: : ' . $response_object['raw_message'] . "\n";
