...
class ControllerExtensionPaymentPayscout extends Controller {
	...
	public function send() {
		...
		$client_username = $this->config->get('payment_payscout_username');
		$client_password = $this->config->get('payment_payscout_password');
		$client_token = $this->config->get('payment_payscout_token');
		
		if((int)$this->config->get('payment_payscout_server') == 0)
		{
